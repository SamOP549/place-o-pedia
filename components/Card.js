    ...
    return (
        <div>
            ...
            <div class="rounded overflow-hidden shadow-lg p-3 bg-black card">
                ...
                <img class="card_image" src={finalURL} alt="" />
                <div class="px-2 py-4">
                    ...
                    <form action="http://maps.google.com/maps" method="get" target="_blank">
                        ...
                        <button type="submit" value='Get directions' class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Directions</button>
                    </form>
                </div>
                </div>
